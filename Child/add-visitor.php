            ...
            <ul class="nav">
                ...
                <li class="active">
                    ...
                    <div class="collapse in" id="visitors-child">
                        <ul class="nav">
                            <li class="active"><a href="add-visitor.html">Add new visitor</a></li>
                            <li><a href="edit-visitor.html">Edit existing visitor</a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Add new visitor</h4>
                            </div>
                            <div class="content">
                                <form>
<div class="row">
                      <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Last Name (Disabled)</label>
